...
//		// submenu
		Main_Menu.Menu_Insert(1001, new Item(ITEM_PARAM16, &dead_zone1, "死区1%5.0fns"), 1000);
		Main_Menu.Menu_Insert(1002, new Item(ITEM_PARAM16, &dead_zone2, "死区2%5.0fns"), 1000);
